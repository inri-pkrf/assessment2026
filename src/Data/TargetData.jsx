const TargetData = {
    "מבצעים": [
        ...
        },
        {
            name: "מאפשר כוח-אדם",
            connections: [
                "תוכנית הצבת כוח-אדם למשימות הרשות.",
                "מנגנון להעלאת התייצבות עובדים ותגבור כוח-אדם חיצוני.",
    ...
    "אוכלוסיה": [
        ...
        },
        {
            name: "מאפשר כוח-אדם",
            connections: [
                'בניית מערך מתנדבים ומשאבי קהילה לתגבור כוח-אדם למשימות הרשות.',
    ...
    "חינוך": [
        {
            name: "יעד מזון ומים",
            connections: [
                'תכנון תגבור כוח-אדם מקצועי (חינוכי וטיפולי) למשימות מכלול אוכלוסייה.'
            ]
        },
        {
            name: "יעד מחסה הולם",
            connections: [
                'מוכנות וכשירות כוח-אדם וסגל חינוכי לניהול מתקני הקליטה.',
        ...
        },
        {
            name: "יעד שירותי רפואה",
            connections: [
                'גיבוש כוח-אדם מקצועי טיפולי לתמיכה נפשית (שפ"ח)לעיבוי צוותי ההתערבות.'
            ]
        },
        {
            name: "מאפשר כוח-אדם",
            connections: [
                'בניית מערך מתנדבים בני נוער לתגבור כוח-אדם למשימות הרשות.',
                'פתיחת מסגרות לילדי עובדים.',
                'תוכנית כוח-אדם לביצוע משימות המכלול: הצבת עובדים, מיפוי פערי התייצבות, מענה לעובדים, איתור והכשרת מתנדבים.'
            ]
        },
        {
            name: "מאפשר אנרגיה",
            connections: [
                'מוכנות וכשירות הרדיו החינוכי ברשות (כוח-אדם, מיגון, גנרציה), כולל אפשרות דילוג.'
            ]
        },
        {
            name: "מאפשר מידע לציבור",
    ...
    "מידע לציבור": [
        ...
        },
        {
            ...
            connections: [
                ...
                'מוכנות וכשירות המוקד רשותי ובעל רציפות תפקודית (כוח-אדם, מיגון, גנרציה), כולל דילוג/ הרחבת מוקד.',
    ...
    "הנדסה ותשתיות": [
        ...
        },
        {
            name: "מאפשר כוח-אדם",
            connections: [
                'תוכנית כוח-אדם לביצוע משימות המכלול: הצבת עובדים, מיפוי פערים צפויים בחירום, גיבוש מענה לעובדים, איתור והכשרת מתנדבים.'
            ]
        },
        {
            name: "מאפשר אנרגיה",
    ...
    'מינהל כללי ומשא"ן': [
        {
            name: "יעד מזון ומים",
            connections: [
                'איתור ותכנון כוח-אדם (כולל כוח-אדם עם רכבים) למשימות חלוקת מים ומזון.'
            ]
        },
        {
            name: "יעד מחסה הולם",
            connections: [
                'איתור ותכנון כוח-אדם למשימות תפעול של מתקני הקליטה ומחסות ציבוריים.'
            ]
        },
        {
            name: "יעד שירותי רפואה",
            connections: [
                'איתור ותכנון כוח-אדם למשימות סיוע ושינוע של נתמכי נשימה למרכז גנרציה.',
                'איתור כוח-אדם עם כלי רכב למשימת חלוקת תרופות.'
            ]
        },
        {
            name: "מאפשר כוח-אדם",
            connections: [
                'תוכנית הצבת כוח-אדם (מתנדבים ועובדים) למשימות הרשות. חיזוי פערי כוח-אדם בחירום ובניית תוכנית להעלאת ההתייצבות.',
                ...
                'גיוס ורישום מתנדבים להגדלת מאגר כוח-אדם הרשותי.'
            ]
        },
        {
            name: "מאפשר אנרגיה",
        ...
        },
        {
            name: "מאפשר מידע לציבור",
            connections: [
                'איתור ותכנון כוח-אדם למשימות מכלול מידע לציבור: כוח-אדם מקצועי, מובילי דעת קהל, דוברי שפות, כוח-אדם לתגבור יכולות מענה והפצת מידע.',
